...
Проект PythonProject4 включает в себя домашние задания 9.1, 9.2, 10.1 и 10.2.
В домашнем задании 10.2 созданы модули тестирования 'test_processing.py', 'test_masks.py' и 'test_widget.py' в которых
