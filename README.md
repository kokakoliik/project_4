...
Проект PythonProject4 включает в себя домашние задания 9.1, 9.2, 10.1, 10.2 и 11.1.
В домашнем задании 11.1 создан модуль`generators`, который содержит функции для работы с массивами транзакций.
## Установка
